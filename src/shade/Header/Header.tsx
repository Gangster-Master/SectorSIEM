...
import {Button, Dropdown, Form, Modal, Navbar} from "react-bootstrap";
import {Scrollbars} from 'react-custom-scrollbars';
import {Link, useNavigate} from "react-router-dom";
import {auth} from "../../Firebase/firebase";
import {useTranslation} from "react-i18next";
import {DEFAULT_LANG, LANGUAGES} from "../../core/constants/language.constants";
                            ...
                            <ul className="nav nav-item header-icons navbar-nav-right ">
                                <li className="dropdown nav-item">
                                    <>
                                        ...
                                        >
                                            <Modal.Header>
                                                <h6 className="modal-title">Choose Language</h6>
                                                <Button variant="" type="button" className={''} onClick={() => setLang(false)}>
                                                    <span aria-hidden="true" className="text-dark mdi mdi-close"></span>
                                                </Button>
                                            </Modal.Header>
                                            <Modal.Body>
                                                {LANGUAGES.map((lang, index) => <div key={index} className="mb-2">
                                                    <Link to="#" className={`btn btn-country btn-lg btn-block p-1 ${currentLang === lang.code && 'active'}`} onClick={() => {changeLanguage(lang.code)}}>
                                                        <span className="country-selector">
                                                            <img alt="" src={require(`../../assets/img/flags/${lang.code}.svg`)} className="me-3 language"/>
                                                        </span> {t(lang.label)}
                                                    </Link>
                                                </div>)}
                                            </Modal.Body>
                                ...
                                <li className="dropdown nav-item">
                                    <Link to="#" className="new nav-link theme-layout nav-link-bg layout-setting" onClick={() => Darkmode()}>
