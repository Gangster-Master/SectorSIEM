                ...
                if (mainlevel.Items) {
                    mainlevel.Items.map((items: any) => {
                        ...
                        if (location.pathname === '/' || location.pathname === '/') {
                            location.pathname = '/dashboard/dashboard-1/';
                        }
                ...
                >
                    ...
                    >
                        <div className="main-sidebar-header active">
                            <NavLink className="header-logo active" to={`/dashboard/dashboard-1`}>
                                <img
                                                            ...
                                                            return (
                                                                <li key={index} className={`sub-slide ${childrenItem.selected ? "is-expanded" : ""} ${childrenItem.active ? "is-expanded" : ""}`}>
                                                                    ...
                                                                    {childrenItem.type === "link" ? (
                                                                        <span>
                                                                            <NavLink
                                                                                to={`${menuItem.path || ''}/${childrenItem.path}`}
                                                                                ...
                                                                                (childrenSubItem: any, key: any) => (
                                                                                    <li key={key}>
                                                                                        {childrenSubItem.type === "link" ? (
                                                                                            <NavLink
                                                                                                to={`${menuItem.path || ''}/${childrenItem.path}/${childrenSubItem.path}`}
                                                                                        ...
                                                                                        {childrenSubItem.type === "sub" ? (
                                                                                            <span
                                                                                                ...
                                                                                                <NavLink to="#" className="sub-side-menu__item" onClick={(event) => {
                                                                                                    event.preventDefault();
                                                                                                        ...
                                                                                                        >
                                                                                                            {childrenItem.children.map(
                                                                                                                (childrenSubItemsubs: any, key: any) => (
                                                                                                                    <li key={key}>
                                                                                                                        <NavLink className="sub-slide-item2"
                                                                                                                                 to="#">{childrenSubItemsubs.title}{childrenSubItemsubs.active}</NavLink>
                                                                                                                    </li>
                                                                                                                )
                                                                                                            )}
                                                                                                        </ul>
